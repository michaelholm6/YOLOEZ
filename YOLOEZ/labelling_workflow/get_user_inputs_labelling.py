...
You will have a chance to edit these annotations later. This should be a .pt file, and can be a model you have previously trained using this tool."
        ...
        conf_layout = QtWidgets.QHBoxLayout(conf_container)
        conf_layout.setContentsMargins(0, 0, 0, 0)
        conf_layout.setSpacing(4)

        conf_label = QtWidgets.QLabel("Bootstrapping Confidence Threshold:")
        icon_label = QtWidgets.QLabel()
        icon_pix = self.style().standardIcon(QtWidgets.QStyle.SP_MessageBoxQuestion)
        icon_label.setPixmap(icon_pix.pixmap(14, 14))
        icon_label.setToolTip(
            "Set the minimum confidence required for the bootstrapping model to add a contour. "
            "Contours below this confidence will be ignored."
        )

        conf_layout.addWidget(conf_label)
        conf_layout.addWidget(icon_label)
        ...
        icon_pix = self.style().standardIcon(QtWidgets.QStyle.SP_MessageBoxQuestion)
        unlabeled_icon.setPixmap(icon_pix.pixmap(14, 14))
