...
""")
        ...
        # Add this in the __init__ method along with other controls
        self.save_yolo_checkbox = QtWidgets.QCheckBox()

        # Add a label + checkbox layout similar to suppress checkbox
    ...
    def get_values(self):
        ...
        if folder and filename:
            ...
            full_output_path = filename or folder

        return {
            "image_path": self.image_path_edit.text(),
            "suppress_instructions": self.suppress_checkbox.isChecked(),
            "output_path": full_output_path,
            "YOLO_true": self.save_yolo_checkbox.isChecked()  # <-- returns True if checked
        }
