...
from DefectDetect.labelling_workflow.save_box_results import *
from DefectDetect.labelling_workflow.crop_and_mask import *
from DefectDetect.labelling_workflow.bootstrap_runner import *
...
def run_labeling_workflow(suppress_instructions=False):
    ...
    if args['bootstrapping_model'] != None:
        ...
        detection_results = run_yolo_on_crops(cropped_images, args['bootstraping_model'])
    ...
    if args['annotation_mode'] == 'segmentation':
        ...
        contours = run_contour_editor(cropped_images, line_thickness)
        ...
        contours = run_box_editor(cropped_images, line_thickness)
        
    if args['annotation_mode'] == 'segmentation':
    
        save_segmentation_results(images, contours, line_thickness, args["output_folder"], areas_of_interest)
        
    else:
    
        save_box_results(images, contours, line_thickness, args["output_folder"], areas_of_interest)  
