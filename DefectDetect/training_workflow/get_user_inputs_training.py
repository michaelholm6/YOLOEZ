...
class YOLOTrainingDialog(QtWidgets.QDialog):
    def __init__(self):
        ...
        dataset_container = make_label_with_tooltip(
            ...
            "Select the root folder containing your training images and YOLO label txt files."
        )
        ...
        # Transformations
        # --- Transformations ---
        left_layout.addWidget(QtWidgets.QLabel("Apply Transformations:"))
        self.transform_options = [
            ("Flip", "Horizontally flip images."),
            ("Rotate", "Rotate images. Disabled for detection tasks."),
        ...
        model_label_container = make_label_with_tooltip(
            "YOLO Model Size:",
            "Select the model size (nano, small, medium, large, extra-large) to train."
        )
        ...
        split_container = make_label_with_tooltip(
            ...
            "Specify the fraction of images used for training. The rest will be used for validation."
        )
        ...
        prev_model_container = make_label_with_tooltip(
            ...
            "Optional: Select a previously trained YOLO model to continue training."
        )
